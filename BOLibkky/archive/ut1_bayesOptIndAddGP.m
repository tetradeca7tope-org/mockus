% Unit Test for additive GP Bayesian Optimization
...
boAddParams.numInitPtsPerGroup = 4 * round(numDims/numGroups);
boAddParams.meanFuncs = [];
boAddParams.meanFunc = [];
...
[maxVal, maxPt, boAddQueries, boAddVals, boAddHist] = ...
  bayesOptIndAddGP(func, decomposition, bounds, numIters, boAddParams);
