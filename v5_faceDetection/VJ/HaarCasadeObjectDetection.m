...
% ScaleUpdate = Options.ScaleUpdate;
% ScaleUpdate = 1000;
ScaleUpdate = 0.9;
...
itt=ceil(log(1/StartScale)/log(ScaleUpdate));

% Do the Objection detection, looping through all image scales
for i=1:itt
    % Current scale
    Scale =StartScale*ScaleUpdate^(i-1);    
    ...
    [x,y] = OneScaleObjectDetection( x, y, Scale, IntegralImages, w, h, ...
            HaarCasade, thresholds);
