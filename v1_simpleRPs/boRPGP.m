function [maxVal, maxPt, boQueries, boVals, history] = boRPGP(oracle, ...
  bounds, projDims, numIters, params)
  ...
  for boIter = 1:numIters
    ...
    nextPt = alCandidates(nextPtIdx, :);
    nextPtStd = candStds(nextPtIdx);
    % Query next pt 
